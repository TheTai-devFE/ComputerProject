        ...
        <div className="py-4 shadow-md">
          <ul className="container mx-auto flex flex-wrap justify-between md:flex-row px-4 md:px-2 items-center relative">
            ...
            <User
              onClick={hanldeUser}
              size={50}
              className="bg-gray-200 text-black rounded-full px-3 py-2 cursor-pointer"
            />
          </ul>
        </div>
        <nav className="flex justify-between items-center container mx-auto md:py-6 py-8 px-2">
          ...
          <div className="relative">
            <Link to="/cart">
              ...
              />
              {itemCount > 0 && (
                <span className="absolute -top-2 -right-1 bg-blue-600 text-white text-xs rounded-full w-5 flex items-center justify-center">
                  {itemCount}
                </span>
              )}
            </Link>
